...
{
private static readonly (string Code, string Name, int MaxCapacity)[] Courses =
[
...
("MOB-201", "Cross-Platform Mobile", 24),
...
{
    // First make sure the database schema is up to date.
    ...
    foreach (var (code, name, maxCapacity) in Courses)
    {
